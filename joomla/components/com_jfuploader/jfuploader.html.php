      ...
      if (acivateKeep && (oldKeepAlive != null)) { 
		...
		$objecttag = '
          <object name="mymovie" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="'.$width.'" height="'.$height.'"  align="middle">
            ...
            <param name="movie" value="'.$relative_dir.$prefix_path.'components/com_jfuploader/tfu/tfu_216.swf?joomla=frontend&amp;session_id='.$sess_id.'&amp;lang='.$lang.'&amp;base='.$base_dir.'&amp;relative_dir='.$relative_dir.$extra_settings.'&amp;'.$row->swf_text.'" />
            <param name="quality" value="high" /><param name="bgcolor" value="#ffffff" />';
             if ($width == '650') {
                $objecttag .= '<param name="scale" value="noScale" />';
             }
            $objecttag .= '<param name="allowFullScreen" value="true" />
            <embed src="'.$relative_dir.$prefix_path.'components/com_jfuploader/tfu/tfu_216.swf?joomla=frontend&amp;session_id='.$sess_id.'&amp;lang='.$lang.'&amp;base='.$base_dir.'&amp;relative_dir='.$relative_dir.$extra_settings.'&amp;'.$row->swf_text.'" name="mymovie" quality="high" bgcolor="#ffffff" width="'.$width.'" height="'.$height.'" align="middle" '. (($width == '650') ? 'scale="noScale" ' : '') . ' allowfullscreen="true" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
            </object> ';
		...
		if ($use_js_include) { // include with Javascript
			...
			<script type="text/javascript">
			   document.write(\'<div style="height:'.$height.'px;" id="flashcontent"><div class="noflash">TWG Flash Uploader requires at least Flash 8.<br>Please update your browser.<\/div><\/div>\');
                ...
                $output .= '  swfobject.embedSWF("'.$relative_dir.$prefix_path.'components/com_jfuploader/tfu/tfu_216.swf", "flashcontent", "'.$width.'", "'.$height.'", "8.0.0", "", flashvars, params, attributes);
                ';		   
                $output .= '
			</script>

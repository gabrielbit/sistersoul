...
define( 'JNEWSJ_ADMIN_IMG', JNEWS_JPATH_LIVE .DS . 'administrator' . DS .'images'. DS );
define( 'JNEWSCOMP_AIMG', JNEWS_JPATH_LIVE .DS . 'administrator' . DS . 'components' . DS . JNEWS_OPTION . DS .'images'. DS );
...
//includes url
define( 'JNEWS_URL_INCLUDES', JNEWS_PATH_FRONT.'includes'.DS );

...
class plgSystemSourcererHelper
{
	function __construct( &$params )
	{
		...
		$security_group = $params->articles_security_level;
		$security_group_css = $params->articles_security_level_default_css ? $params->articles_security_level : $params->articles_security_level_css;
		$security_group_js = $params->articles_security_level_default_js ? $params->articles_security_level : $params->articles_security_level_js;
		$security_group_php = $params->articles_security_level_default_php ? $params->articles_security_level : $params->articles_security_level_php;
		...
		$this->src_params->areas['articles']['security'] = $acls[$security_group]['4'];
		$this->src_params->areas['articles']['security_css'] = $acls[$security_group_css]['4'];
		$this->src_params->areas['articles']['security_js'] = $acls[$security_group_js]['4'];
		$this->src_params->areas['articles']['security_php'] = $acls[$security_group_php]['4'];

<?php
/**
 * JFUploader 2.16.x Freeware - JFUploader Editor button for Joomla 1.5.x
 *
	   ...
	   $relative_dir = $relative_dir['path'];
        $relative_dir = rtrim($relative_dir,"\\/.") . '/'; // we replace to get a consistent output with different php versions!
          ...
          $css = ".button2-left .jfuButton {
                    background: transparent url(".$relative_dir.$prefix."plugins/editors-xtd/jfuploader_editor.png) no-repeat 100% 0px;
                }";

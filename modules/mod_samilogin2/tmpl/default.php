...
<form id="samiform" action="<?php echo JRoute::_( 'index.php', true); ?>" method="post" name="login" id="form-login" >
	...
	<?php endif; ?>
	<input type="submit" name="Submit" class="button" value="<?php echo JText::_('Login') ?>" style="width:100px;border:1px solid #792677;background-color:#CFA4DD;height:30px;" />
	</fieldset>
	<ul>
		<li>
			<a href="<?php echo JRoute::_( 'index.php?option=com_user&view=reset' ); ?>">
			<?php echo JText::_('Olvidastes tu Contraseña ?'); ?></a>
		</li>
		<li>
			<a href="<?php echo JRoute::_( 'index.php?option=com_user&view=remind' ); ?>">
			<?php echo JText::_('Olvidastes tu Usuario'); ?></a>
		</li>
		<?php

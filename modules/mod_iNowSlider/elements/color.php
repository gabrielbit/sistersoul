...
class JElementColor extends JElement {
	...
	function fetchElement($name, $value, &$node, $control_name) {
		ob_start();
		$img=JUri::root()."modules/mod_iNowSlider/images/rainbow.png";
		$imgx=JUri::root()."modules/mod_iNowSlider/images/";
		static $embedded;
		if(!$embedded) {
			$css2=JUri::root()."modules/mod_iNowSlider/css/mooRainbow.css";
			$jspath=JUri::root()."modules/mod_iNowSlider/js/mooRainbow.js";
?>

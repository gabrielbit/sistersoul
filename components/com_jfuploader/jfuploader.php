...
global $Itemid, $m, $mainframe, $prefix_path, $prefix_dir_path, $prefix_path;
...
// Parameters
$params = &JComponentHelper::getParams('com_jfuploader');
...
if (($sel_id == '0' && $id == '1') || $sel_id == '' || $id == '') { // admin profile or no id!
    ...
    if ($myId > 1) { // admin profile  is not allowed in the frontend
        showFlashComponent($myId, $user, $editor_plugin, $block_type, $jfu_params);
    } else {

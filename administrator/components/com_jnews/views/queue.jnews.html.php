...
class jNews_QueueHTML {
	...
	function showMailingQueue($mailingq=null,$lists=null, $form, $start,$limit,$mailingsearch,$setLimit=null, $setSort=null){
	$listId = null;
		?>
		...
		$mySepList[0]->id = 0;
		$lt = array_merge($mySepList, jNews_Mailing::getMailingsForQueue());
...
/**
	 * This function is used to process the queue manually
	 */
	function processQueueHTML( $queuedMails=null, $nextQueuedMails=null, $scheduledMails=null, $mailingid=null, $sendButton=false, $SmartNewsMessageHTML='' ) {
...
<?php
	...
	function _displayQueue($mailingq,$i){

...
echo '<center><form action="index2.php" method="post" name="adminForm" id="adminForm">
<input type="hidden" name="option" value="com_jfuploader"/>
<input type="hidden" name="task" value="config"/>
</form>';
...
echo '
   swfobject.embedSWF("'.$pathfix.'components/com_jfuploader/tfu/tfu_216.swf?joomla=true&lang='.$lang.'&session_id='.session_id().'&base='.$base_dir.'&relative_dir='.$relative_dir.$extra_settings.'&'.$row->swf_text.'", "flashcontent", "'.$width.'", "'.$height.'", "8.0.0", "", flashvars, params, attributes);
';
echo <<< HTML
	</script>
...
function show_md5() {
  ...
  var text = escapeHTML(' " . JText::_('P_INST') . "') + '<br>&nbsp;<br> {jfuploader type='+value.substr(0,1)+' id='+value.substr(value.indexOf(\"_\", 0)+1)+' securitytoken=' + MD5(value) + '} <br>&nbsp;'; 
...
<table class="admintable">
	 ...
	 <tbody>
		...
		<tr>
			...
			<td>'.tfuHTML::showProfileList('sa_profil',
			'class="inputbox"',$jfu_config['sa_profil']) . '</td>
			<td>'.JText::_('E_D_PROFIL_SA').'</td>
		</tr>
		<tr>
			<td class="key">'.JText::_('E_S_PROFIL_A').'</td>
			<td>'.tfuHTML::showProfileList('a_profil',
			'class="inputbox"',$jfu_config['a_profil']) . '</td>
			<td>'.JText::_('E_D_PROFIL_A').'</td>
		</tr>
		<tr>
			<td class="key">'.JText::_('E_S_PROFIL_M').'</td>
			<td>'.tfuHTML::showProfileList('m_profil',
			'class="inputbox"',$jfu_config['m_profil']) . '</td>
			<td>'.JText::_('E_D_PROFIL_M').'</td>
		</tr>   	
		<tr>
...
function showConfig($row, $a_user, $p_user, $do_check_image_magic, $showUserPage = false) {    
...
$im_status = (($im_check) == '1') ? '<p><img src="images/tick.png" style="vertical-align:middle;"" /> &nbsp;' .JText::_('E_D_USE_IMAGE_MAGIC_OK') . '</p>' : ((($im_check) == '0') ? ' <p><img src="images/publish_x.png" style="vertical-align:middle;"" /> &nbsp;' .JText::_('E_D_USE_IMAGE_MAGIC_FAIL') . '</p>':' <p><img src="images/publish_x.png" style="vertical-align:middle;"" /> &nbsp;' .JText::_('E_D_CHECK_IMAGE_MAGIC_DISABLED') . '</p>');
echo '
<script type="text/javascript" src="components/com_jfuploader/js/jfu.js"></script>
...
echo '
<p style="text-align:left;">'.JText::_('E_USER_MAIN').'</p>';
echo '
<p>'.JText::_('E_USER_HELP').'</p><p>
'.JText::_('U_FILTER').' <input id="filter" onkeyup="doFilterList(this, \'list_1\');doFilterList(this, \'list_2\');" /> &nbsp;<a onclick="blur(); return resetListFilter();" href="#"><img src="images/cancel.png" style="margin:-3px;" height=14 border="0" /></a></p>
<div class="panel">
...
<form action="index2.php" method="post" name="adminForm" id="adminForm">
  ...
  <p>'.JText::_('U_FILTER').' <input name="filter" onkeyup="doFilter(this, \'usermappings\');" type="text" /> &nbsp;<a onclick="blur(); return resetUserFilter();" href="#"><img src="images/cancel.png" style="margin:-3px;" height=14 border="0" /></a></p>
...
'.JText::_('H_P_TEXT').'
 ...
 <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist" >
       ...
       <tr>
          ...
          <th align="left" width="20%">'.JText::_('NAME').'</th>
          <th align="left" width="60%">'.JText::_('DESCRIPTION').'</th>  

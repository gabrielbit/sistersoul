...
myConnB.connect( "index2.php?option=com_jfuploader&no_html=1&task=changeProfile&type=disable&profile="+id, fnWhenDoneR);
}
...
myConnB.connect( "index2.php?option=com_jfuploader&no_html=1&task=changeProfile&type=enable&profile="+id, fnWhenDoneR);
}
...
myConnB.connect( "index2.php?option=com_jfuploader&no_html=1&task=changeMaster&type=disable&profile="+id, fnWhenDoneR);
}
...
myConnB.connect( "index2.php?option=com_jfuploader&no_html=1&task=changeMaster&type=enable&profile="+id, fnWhenDoneR);
}
...
myConnB.connect( "index2.php?option=com_jfuploader&no_html=1&task=testFolder&folder="+escape(folder), fnWhenDoneR);
} else {
...
function checkFolderDone(ret) {
  if (startsWith(ret,"JFU:OUTPUT:1")) {
    document.getElementById("foldertestimage").src = 'images/tick.png';
  } else if (startsWith(ret,"JFU:OUTPUT:2")) {
...
function startsWith(estring, str)
{return (estring.match("^"+str)==str)}
